...
exports.VAPI_TOOL_DEFINITIONS = void 0;
exports.VAPI_TOOL_DEFINITIONS = [
    {
        type: 'function',
        function: {
            name: 'update_lead',
            description: 'Update the lead record with information extracted from the conversation so far (products, budget, timeline, features, decision maker status, etc.)',
            parameters: {
                type: 'object',
                properties: {
    ...
    },
    {
        ...
        function: {
            name: 'send_whatsapp',
            description: 'Send a personalized WhatsApp message to the customer during the active call. Use this only when the customer shows high buying intent (HOT lead). Never call this more than once per lead.',
            parameters: {
                type: 'object',
                properties: {
                    callId: { type: 'string', description: 'Internal MongoDB call ID' },
    ...
    },
    {
        ...
        function: {
            name: 'book_callback',
            description: 'Schedule a callback when the customer requests one. Extract the requested time in natural language (e.g. "tomorrow morning", "kal evening", "next Monday afternoon").',
            parameters: {
                type: 'object',
                properties: {
                    callId: { type: 'string', description: 'Internal MongoDB call ID' },
...
//# sourceMappingURL=vapi-tool-definitions.js.map