export const LEAD_CLASSIFICATION_PROMPT = `You are a lead qualification system for an e-commerce website development sales pipeline. You receive extracted lead information from a sales call.
